...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow pt-24 px-6 pb-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div
            class="md:col-span-4 space-y-6 md:sticky md:top-24 md:self-start md:max-h-[calc(100vh-8rem)] md:overflow-y-autocustom-scrollbar">
            <!-- Project Logo Module -->
            <!-- Project Logo Module -->
