...
<body class="min-h-screen flex flex-col">
    ...
    <div id="kmnft-drawer" class="fixed top-16 right-0 h-[calc(100dvh-4rem)] w-72 bg-[#0d0d1a] border-l border-white/10 z-40 translate-x-full transition-transform duration-300 ease-in-out overflow-y-auto">
        <nav class="flex flex-col p-6 gap-5">
            ...
            <a href="<?php echo home_url('/dashboard'); ?>" class="kmnft-drawer-link border border-kmnft-green text-kmnft-green text-sm font-bold px-4 py-2 rounded text-center tracking-widest hover:bg-kmnft-green hover:text-black transition">DASHBOARD</a>
            <?php if ($is_logged_in): ?>
                            ...
                            <?php foreach ($match_results as $index => $match): ?>
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between items-start gap-2 mb-3">
                                        <div class="text-xs text-gray-400 font-mono flex flex-col md:flex-row md:items-center md:gap-1">
                                            <?php if (!empty($match->section_label)): ?>
                                                <span
                                                    class="text-kmnft-gold whitespace-nowrap"><?php echo esc_html($match->section_label); ?></span>
                                            <?php endif; ?>
                                            <span class="whitespace-nowrap"><?php echo esc_html($match->match_date); ?></span>
                                        </div>
                                        <div class="text-sm font-bold whitespace-nowrap <?php echo $resultTextColor; ?>">
                                            <?php echo $resultText; ?>
                                ...
                                <div class="<?php echo $is_hidden_history; ?>">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div
                                                class="glass-card p-3 rounded bg-kmnft-navy/50 border border-kmnft-green/30 shadow-[0_0_15px_rgba(57,255,20,0.05)] flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                                                <!-- 上段: ラベル + クラブ名 -->
                                                <div class="flex items-center gap-2">
                                                    <div class="w-2 h-2 rounded-full bg-kmnft-green flex-shrink-0"></div>
                                                    <div class="text-[10px] text-gray-400 uppercase tracking-widest whitespace-nowrap">My Club Status</div>
                                                    <div class="text-[10px] text-gray-500 font-mono whitespace-nowrap">Kamakura Intl. FC</div>
                                                </div>
                                                <!-- 下段(スマホ) / 右側(PC): RANK + POINTS -->
                                                <div class="flex items-center gap-4 pl-4 md:pl-0">
